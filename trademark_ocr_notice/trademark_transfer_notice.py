...
transfer_notice_db = DB["trademark"]["trademark_transfer_notice"]



def ocr_img(img_path):
    img_dict = {
        "first_img": [r"E:\img\trademark_transfer_notice\ocr\first_img.jpg", (0, 0, 1110, 135)],
        "second_img": [r"E:\img\trademark_transfer_notice\ocr\second_img.jpg", (70, 132, 1110, 424)],
        "three_img": [r"E:\img\trademark_transfer_notice\ocr\three_img.jpg", (70, 424, 1110, 800)],
        "four_img": [r"E:\img\trademark_transfer_notice\ocr\four_img.jpg", (70, 800, 1110, 1150)],
        "five_img": [r"E:\img\trademark_transfer_notice\ocr\five_img.jpg", (70, 1160, 1110, 1550)],
    }
    ...
    for _ in img_lt:
        ...
        if count == 1:
            ...
            res_dict["block"] = "1"
            res_dict["registration_number"] = result[0][0:-2].split(":")[1]
            _id = prefix + f"_{result[0][0:-2].split(':')[1]}"
            ...
            res_dict["Transferee"] = result[4].split(":")[1][0:-1]
            ...
            res_dict["Transferor"] = result[3].split(":")[1][2:]
            res_dict["Transferee"] = result[4].split(":")[1]
            transfer_notice_db.save(res_dict)
...
import os
file_lt = os.listdir(r'E:\img\trademark_transfer_notice')

for _ in file_lt:
    if _ == "ocr":
        continue
    else:
        img_path = r"E:\img\trademark_transfer_notice\{}".format(_)
        print(img_path)
        ocr_img(img_path)
