...
transfer_notice_db = DB["trademark"]["preliminary"]

def ocr_img(img_path,imgName):
    img_dict = {
        "first_img": [r"E:\img\preliminary\ocr\first_img.jpg", (0, 0, 1110, 120)],
        "second_img": [r"E:\img\preliminary\ocr\second_img.jpg", (101, 120, 1083, 338)],
        "three_img": [r"E:\img\preliminary\ocr\three_img.jpg", (103, 338, 1103, 436)],
        "four_img": [r"E:\img\preliminary\ocr\four_img.jpg", (103, 877, 1097, 1163)],
    }
    ...
    for _ in img_lt:
        ...
        if count == 1:
            ...
            # 块，注册号
            # res_dict["block"] = "1"
            res_dict["registration_number"] = result[0][1:8]
...
import os
file_lt = os.listdir(r'E:\img\preliminary')

for _ in file_lt:
    if _ == "ocr":
        continue
    else:
        img_path = r"E:\img\preliminary\{}".format(_)
        print(img_path)
        imgName = _.split(".")[0]
