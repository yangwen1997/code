...
const jsdom = require("C:\\Users\\Administrator\\AppData\\Roaming\\npm\\node_modules\\jsdom");
const { JSDOM } = jsdom;
...
s.prototype.e = function (e) {
    ...
    i.prototype.e = function (e) {
        switch (this.t) {
            case 0:
                e.requirements[this.s] = this.i;
                break;
            case 1:
                e.requirements[this.s] = e.k[this.h];
        }
    }
    ,
    h.prototype.e = function (e) {
        e.k[this.h] = e.requirements[this.s];
    }
    ,
    a.prototype.e = function (e) {
        switch (this.t) {
            case 0:
                e.requirements[this.a] = e.requirements[this.c] + e.requirements[this.n];
                break;
            case 1:
                e.requirements[this.a] = e.requirements[this.c] - e.requirements[this.n];
                break;
            ...
            case 9:
                ...
                break;
            case 10:
                e.requirements[this.a] = t(e.requirements[this.c]);
                break;
            case 11:
                e.requirements[this.a] = e.requirements[this.c] in e.requirements[this.n];
                break;
            case 12:
                e.requirements[this.a] = e.requirements[this.c] > e.requirements[this.n];
                break;
            case 13:
                e.requirements[this.a] = -e.requirements[this.c];
                break;
            case 14:
                e.requirements[this.a] = e.requirements[this.c] < e.requirements[this.n];
                break;
    ...
    e.prototype.e = function (e) {
        switch (this.t) {
            case 0:
                e.u = e.requirements[this.a] >= e.requirements[this.c];
                break;
            case 1:
                e.u = e.requirements[this.a] <= e.requirements[this.c];
                break;
        ...
        switch (this.t) {
            case 0:
                for (var t = [], n = 0; n < this.i; n++)
                    t.unshift(e.f.pop());
                e.requirements[3] = e.requirements[this.s](t[0], t[1]);
                break;
            case 1:
                for (var r = e.f.pop(), i = [], o = 0; o < this.i; o++)
                    i.unshift(e.f.pop());
                e.requirements[3] = e.requirements[this.s][r](i[0], i[1]);
                break;
            case 2:
                for (var a = [], s = 0; s < this.i; s++)
                    a.unshift(e.f.pop());
                e.requirements[3] = new e.requirements[this.s](a[0], a[1]);
        }
    }
;
var k = function (e) {
...
Q.prototype.e = function (e) {
    switch (this.t) {
        case 0:
            e.f.push(e.requirements[this.s]);
            break;
        case 1:
            e.f.push(this.i);
            break;
    ...
    C.prototype.e = function (A) {
        switch (this.t) {
            case 0:
                var t = A.f.pop();
                A.requirements[this.a] = A.requirements[this.c][t];
                break;
            case 1:
                var s = A.f.pop()
                    , i = A.f.pop();
                A.requirements[this.c][s] = i;
                break;
            case 2:
                var h = A.f.pop();
                A.requirements[this.a] = eval(h);
        }
    }
    ,
    B.prototype.e = function (e) {
        e.requirements[this.s] = k(e.b[this.h]);
    }
    ,
    ...
    w.prototype.e = function (e) {
        switch (this.t) {
            case 0:
                ...
                e.requirements[this.s] = t;
                break;
            case 1:
                for (var i = [], o = 0; o < this.i; o++)
                    i.unshift(e.f.pop());
                e.requirements[this.s] = i;
        }
    }
    ,
