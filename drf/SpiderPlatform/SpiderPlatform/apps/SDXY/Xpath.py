...
class WaterCredit(object):
    ...
    def gsxx(self,etree):
        ...
        etre = etree
        item = {}
        # 企业名 统一社会信用代码  组织机构代码 工商注册号 经营状态 所属行业 法定代表人 注册资本 成立日期
        item["companyName"] = "".join(etre.xpath('//span[@class="company_name"]/text()'))
        item["creditCode"] = "".join(etre.xpath('//table[@class="table1"]//td[contains(text(),"企业信用代码")]/following-sibling::td[1]/text()'))

        item["organizationCode"] = None
        ...
        # 登记机关 核准日期 营业期限 企业类型 企业地址 经营范围 人员规模 参保人数 曾用名 经营方式 来源网站 存储时间
        ...
        item["personnelScale"] = None
        item["insuredPersons"] = None
        item["usedName"] = None
        item["operation"] = None
