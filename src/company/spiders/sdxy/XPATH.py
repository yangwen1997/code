...
class WaterCredit(object):
    ...
    def gsxx(self,etree):
        ...
        item.update({"OrganizationCode":None})
        ...
        item.update({"industry":None})
        item["registerTime"] = "".join(etre.xpath('//table[@class="table1"]//td[contains(text(),"成立时间")]/following-sibling::td[1]/text()'))
        item["companyType"] = "".join(etre.xpath('//table[@class="table1"]//td[contains(text(),"企业类型")]/following-sibling::td[1]/text()'))
        item["businessTimeout"] = "".join(etre.xpath('//table[@class="table1"]//td[contains(text(),"营业期限")]/following-sibling::td[1]/text()'))

        # 法定代表人 发照日期 注册资本 登记机关 企业地址 经营范围
        item["legalMan"] = "".join(etre.xpath('//table[@class="table1"]//a[@class="color444 name-hover"]/text()'))
        item["confirmTime"] = "".join(etre.xpath('//table[@class="table1"]//td[contains(text(),"核准日期")]/following-sibling::td[1]/text()'))
        item["registerMoney"] = "".join(etre.xpath('//table[@class="table1"]//td[contains(text(),"注册资本")]/following-sibling::td[1]/text()'))
        item["registOrgan"] = "".join(etre.xpath('//table[@class="table1"]//td[contains(text(),"登记机关")]/following-sibling::td[1]/text()'))
        item["registerAddress"] = "".join(etre.xpath('//table[@class="table1"]//td[contains(text(),"企业地址")]/following-sibling::td[1]/text()'))
        item["businessScope"] = "".join(etre.xpath('//table[@class="table1"]//div[@class="overflow"]/text()'))
    ...
    def gdxx(self,etree):
        ...
        for _ in gd_lt:
            ...
            item.update({"hiType":None})
            item["hiName"] = "".join(_.xpath('.//p[@class="left t4-p1"]//text()')).replace("查关联企业","").replace("关联企业","").replace(" ","")
    ...
    def employeeInfo(self,etree):
        ...
        etre = etree
        employeelt = []
        employeeInfo_lt = etre.xpath('//ul[@class="clearfix"]/li')
        for _ in employeeInfo_lt:
            item = {}
            # 主要人员职位 主要人员姓名
            item["scPosition"] = "".join(_.xpath('.//p[@class="left t3-p2"]/text()'))
            item["scName"] = "".join(_.xpath('.//p/span[1]/a/text()'))
    ...
    def gsbg(self,etree):
        ...
        for _ in gdbg_lt:
            item = {}
            # 变更日期 变更事项 变更前 变更后
            item["changeTime"] = "".join(_.xpath('.//div[2]/p[@class="up-el"]/text()')).replace("变更日期：","")
            item["changeItem"] = "".join((_.xpath('.//div[1]/p[@class="up-el"]/text()'))).replace("变更项目：","")
            item["changeBefore"] = "".join(_.xpath('.//div[1]/p[2]/text()')).replace("变更前：","")
            item["changeAfter"] = "".join(_.xpath('.//div[2]/p[2]/text()')).replace("变更后：","")
            filter_item = self.filiters(item)
    ...
    def branchInfo(self,etree):
        ...
        item = {}
        # 分支公司名称 负责人姓名
        item.update({"bCompanyName":None})
        item.update({"bName":None})
    ...
    def investmentInfo(self,etree):
        ...
        for _ in investmentInfo_lt:
            ...
            item["iiCapital"] = "".join(_.xpath('.//p[3]//text()'))
    ...
    def executionInfo(self,etre):
        ...
        for _ in executionInfo_lt:
            ...
            item["diName"] = None
            item["diIdentify"] = None
            item["diLowMan"] = None
            item["diPublishTime"] = None
    ...
    def caseInfo(self,etre):
        ...
        item["caseNum"] = None
        item["caseJudge"] = None
        item["caseHelper"] = None
        item["caseTime"] = None
        item["caseOpen"] = None
        item["endTime"] = None
        item["caseStatus"] = None
        item["plaintiff"] = None
        item["defendant"] = None
    ...
    def equityFreezeInfo(self,etre):
        ...
        item["frzTo"]=None
        item["frzLine"]=None
        item["frzShowDate"]=None
        item["frzOutTime"]=None
        item["frzOutReason"]=None
    ...
    def tddyInfo(self,etre):
        ...
        item["lmMoney"]= None
        item["lmBeMoney"]= None
        item["lmLocation"]= None
        item["lmUse"]= None
        item["lmOtherCode"]= None
        item["lmUseCode"]= None
        item["lmManName"]= None
        item["lmManIdenty"]= None
        item["lmMan"]= None
        item["lmType"]= None
        item["lmFrom"]= None
        item["lmTo"]= None
    ...
    def sbxx(self,etree):
        ...
        for _ in sbxx_lt:
            ...
            item["tmDeadline"] = None
            item["tmSection"] = None
            item["tmAnnounceNum"] = None
            item["tmAnnounceDate"] = None
            item["tmrAnnounceNum"] = None
            item["tmrAnnounceDate"] = None
            item["tmApplyMan"] = None
            item["tmApplyAddres"] = None
            item["tmGoodsService"] = None
            item["tmApplyFlow"] = None
    ...
    def rjzz(self,etree):
        ...
        for _ in rjzz_lt:
            ...
            item["swOwner"] = None
            item["swPublishDate"] = None
            item["swRegisterDate"] = None
    ...
    def pawneeInfo(self,etre):
        ...
        item["eyRegisterNum"]= None
        item["eyStatus"]= None
        item["eyoName"]= None
        item["eyoMoneyNum"]= None
        item["eyoMan"]= None
        item["eyMan"]= None
        item["eyNum"]= None
        item["eyTime"]= None
    ...
    def tdgsInfo(self,etre):
        ...
        item["approUnit"]= None
        item["supplyWay"]= None
        item["agreeDeliveryTime"]= None
        item["agreeStartTime"]= None
        item["actualStartTime"]= None
        item["agreeCompleTime"]= None
        item["actualCompleTime"]= None
        item["agreeMaxVolume"]= None
        item["agreeMinVolume"]= None
